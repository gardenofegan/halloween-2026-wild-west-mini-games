...
assert.strictEqual(state.players[0].yellow, false, 'Player 1 yellow button not pressed');
assert.strictEqual(state.players[0].green, true, 'Player 1 green button pressed');
...
assert.strictEqual(state.players[1].yellow, true, 'Player 2 yellow button pressed');
...
assert.strictEqual(state.players[1].green, false, 'Player 2 green button not pressed');
